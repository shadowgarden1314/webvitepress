...
export default withMermaid({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/shadowgarden1314" },
      {
        icon: {
        ...
        link: "https://firefly.hellowold.dynv6.net/",
      },
      {
        icon: {
        ...
        link: "https://gemini.hellowold.dynv6.net/",
      },
      {
        icon: {
        ...
        link: "https://space.bilibili.com/2136559863",
      },
    ],
    // 底部配置
    footer: {
      copyright: "Copyright@ 2024 Firefly",
    },
    // 设置搜索框的样式
    search: {
      provider: "local",
